                ...
                <div className="flex flex-col w-full max-w-md p-12 space-y-4 text-center bg-white rounded-2xl shadow-2xl  text-black">
                    ...
                    <form className="space-y-4">
                        <div className="flex flex-col text-black">
                            <input id="name" type="text" placeholder="Name" className="rounded-t-md border-black border-2 p-0.5 pl-1" />

                            <input id="url" type="url" placeholder="Photo" className="-mt-1 border-black  border-2 p-0.5 pl-1" />

                            <input id="email" type="email" placeholder="Email" className="-mt-1  border-black border-2 p-0.5 pl-1" />

                            <input id="Password" type="Password" placeholder="Password" className="-mt-1 rounded-b-md border-black border-2 p-0.5 pl-1" />
