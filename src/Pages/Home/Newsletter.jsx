...
const Newsletter = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center mx-5 md:mx-32 bg-white  shadow-2xl my-10 rounded-2xl border" data-aos="zoom-in"  data-aos-duration="1500" data-aos-delay="300">
