...
const Banner = () => {
    return (
        <div>
            <div className="hero min-h-[92vh]" style={{ backgroundImage: `url(${img1})` }}>
                <div className="bg-gradient-to-r from-[#00000080] to-[#0000004D] text-center p-5 text-white w-full h-[92vh]">
                    <div className="space-y-3 flex flex-col justify-center items-center h-[92vh]">
